...
public class VideoUpload1 : MonoBehaviour
{
    ...
    public void OnStoppedRecordingVideo()
    {
        ...
        StartCoroutine(InsertTransform("no_video", OriginPostion.x, OriginPostion.y, OriginPostion.z,
            ...
            1,
            m[0, 0], m[0, 1], m[0, 2], m[0, 3], m[1, 0], m[1, 1], m[1, 2], m[1, 3], m[2, 0], m[2, 1], m[2, 2], m[2, 3], m[3, 0],
            m[3, 1], m[3, 2], m[3, 3], n[0, 0], n[0, 1], n[0, 2], n[0, 3], n[1, 0], n[1, 1], n[1, 2], n[1, 3], n[2, 0], n[2, 1],
            n[2, 2],n[2, 3], n[3, 0], n[3, 1], n[3, 2], n[3, 3],
    ...
    public IEnumerator InsertTransform(string name, float posx, float posy, float posz, float rotx, float roty, float rotz,
        ...
        float lrx, float lry, float lrz, float llx, float lly, float llz,float urx, float ury, float urz, float ulx, float uly,
        float ulz)
    {
