...
while true
    ...
    while previouslyknownid<currentvideoid
        ...
        if jsonresponse.status=="true"
            ...
            if rem(ind,2)==1
                x1=str2num(jsonresponse.z_EE)+0.705; y1=-str2num(jsonresponse.x_EE)+0.89;z1=str2num(jsonresponse.y_EE)-0.033;   
                x0=str2num(jsonresponse.z_origin)+0.705; y0=-str2num(jsonresponse.x_origin)+0.89; z0=str2num(jsonresponse.y_origin)-0.033;
...
%                x1=str2num(jsonresponse.z_EE)+0.4; y1=-str2num(jsonresponse.x_EE);z1=str2num(jsonresponse.y_EE)+0.65; 
                ...
                rzx0=str2num(jsonresponse.rot_origin31); rzy0=str2num(jsonresponse.rot_origin32);rzz0=str2num(jsonresponse.rot_origin33);
                 ...
                 x1=str2num(jsonresponse.z_origin)+0.705; y1=-str2num(jsonresponse.x_origin)+0.89; z1=str2num(jsonresponse.y_origin)-0.033;
                 x0=str2num(jsonresponse.z_EE)+0.705; y0=-str2num(jsonresponse.x_EE)+0.89;z0=str2num(jsonresponse.y_EE)-0.033;   
%   c             x1=str2num(jsonresponse.z_origin)+0.4; y1=-str2num(jsonresponse.x_origin); z1=str2num(jsonresponse.y_origin)+0.65;
